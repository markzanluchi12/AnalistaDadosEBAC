...
Este projeto consiste em uma aplicação de calculadora funcional desenvolvida tanto em automação Shell Script (.sh) quanto em Python, acompanhada de seu arquivo executável para uso direto.
